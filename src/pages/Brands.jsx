...
const Brands = () => {
    ...
    return(
        <Box>
            <Box className='mainContainer' sx={{ padding:0, margin: 0, marginTop: '90px' }} id="brands" >
                <Slider {...setting} className='slider'>
                    <div className="container">
                        <a href="https://www.samsung.com/eg/" target="blank">
                    ...
                    <div className="container">
                        <a href="https://www.kiriazi.com/public/index.php" target="blank" >
                            <img src="/kiriazi.png" alt="kiriazi" />
                        </a>
                    </div>
                    <div className="container">
                        <a href="https://whitewhale-egypt-service.com/" target="blank">
                            <img src="/white.jpg" alt="whitewhale" />
                        </a>
                    </div>
                    <div className="container">
                        <a href="https://www.lg.com/eg_en?gad_source=1&gclid=Cj0KCQjwncWvBhD_ARIsAEb2HW8mWDsteuM_cNTJ2vjQvhzhlNpvf4VkiL_v1WuHrnsNyjfUPrLcrn8aAlj4EALw_wcB" target="blank">
                            <img src="/logo-lg-100-44.svg" alt="LG" />
                        </a>
                    </div>
                </Slider>
            </Box>
            <Container className="containerCard">
                <div className="card">
                    <div className="contentCard">
                        ...
                        <Typography variant="h5">صيانة جميع أجهزة كريازي</Typography>
                        <a href="/kiriazi">تصفح ألأن</a>
                    </div>
                </div>
                <div className="card">
                    <div className="contentCard">
                        <img src="/white.jpg" alt="kiriazi" />
                        <Typography variant="h5">صيانة جميع أجهزة وايت ويل</Typography>
                        <a href="/white">تصفح ألأن</a>
                    </div>
                </div>
                <div className="card">
                    <div className="contentCard">
                        <img src="/logo-lg-100-44.svg" alt="kiriazi" />
                        <Typography variant="h5">صيانة جميع أجهزة إلجي</Typography>
                        <a href="/lg">تصفح ألأن</a>
                    </div>
                </div>
                <div className="card">
                    <div className="contentCard">
                        ...
                        <Typography variant="h5">صيانة جميع أجهزة سامسونج</Typography>
                        <a href="/samsung">تصفح ألأن</a>
                    </div>
                </div>
            </Container>
        </Box>
